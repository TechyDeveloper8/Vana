      ...
      <div className="admin-content">
            ...
            {['All', 'Corporate', 'Concerts', 'Expos', 'Award Shows', 'Stage Tech'].map((cat) => (
              <button
                ...
                style={{
                  ...
                  background: categoryFilter === cat ? 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)' : '#FFFFFF',
                  color: categoryFilter === cat ? '#D4AF37' : '#475569',
                  fontWeight: 600,
                  fontSize: '0.85rem',
                  cursor: 'pointer',
        ...
        {loading ? (
          ...
          <div style={{ background: '#FFFFFF', padding: '48px', borderRadius: '16px', border: '1px solid #e2e8f0', textAlign: 'center', color: '#64748b' }}>
            <i className="fa-solid fa-images fa-3x" style={{ marginBottom: '16px', color: '#94a3b8', display: 'block' }}></i>
            <h3 style={{ fontSize: '1.2rem', margin: '0 0 6px', color: '#0f172a' }}>No event albums found</h3>
            <p style={{ margin: 0, fontSize: '0.9rem' }}>Create a new multi-picture album to showcase your event gallery.</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    <h3 style={{ fontSize: '1.15rem', color: '#0f172a', margin: '0 0 6px', fontWeight: 800 }}>{album.title}</h3>
                    {album.location && (
                      <div style={{ fontSize: '0.8rem', color: '#64748b', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                        <i className="fa-solid fa-location-dot" style={{ color: '#B8860B' }}></i> {album.location}
                      </div>
                    )}
                        ...
                        {album.images.slice(0, 4).map((imgUrl, i) => (
                          <div
                            ...
                            style={{
                              ...
                              borderRadius: '8px',
                              overflow: 'hidden',
                              border: cover === imgUrl ? '2px solid #D4AF37' : '1px solid #cbd5e1',
                              flexShrink: 0
                            }}
                          >
                    ...
                    <div style={{ marginTop: 'auto', display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                      <button
                        ...
                        style={{ flex: 1, padding: '9px 12px', background: 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)', color: '#D4AF37', border: 'none', borderRadius: '8px', fontWeight: 700, fontSize: '0.82rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
                      >
                      ...
                      <button
                        ...
                        style={{ padding: '9px 12px', background: '#f1f5f9', color: '#1e293b', border: '1px solid #cbd5e1', borderRadius: '8px', fontWeight: 600, fontSize: '0.82rem', cursor: 'pointer' }}
                      ...
                      <button
                        ...
                        style={{ padding: '9px 12px', background: '#fef2f2', color: '#ef4444', border: '1px solid #fecaca', borderRadius: '8px', fontWeight: 600, fontSize: '0.82rem', cursor: 'pointer' }}
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', paddingBottom: '12px', borderBottom: '1px solid #f1f5f9' }}>
                ...
                <button onClick={() => setManagingAlbum(null)} style={{ background: 'none', border: 'none', fontSize: '1.4rem', color: '#94a3b8', cursor: 'pointer' }}>×</button>
              </div>
              ...
              <div style={{ background: '#f8fafc', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  <input
                    ...
                    style={{ flex: 1, padding: '10px 14px', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '0.88rem', outline: 'none' }}
                  />
                  <button
              ...
              <div style={{ marginBottom: '24px' }}>
                <h4 style={{ fontSize: '0.95rem', color: '#1e293b', marginBottom: '12px', fontWeight: 700 }}>
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: '12px',
                            overflow: 'hidden',
                            border: isCover ? '3px solid #D4AF37' : '1px solid #cbd5e1',
                        ...
                        >
                          ...
                          {/* Cover badge */}
                          {isCover && (
                            <span style={{ position: 'absolute', top: '6px', left: '6px', background: '#D4AF37', color: '#0f172a', padding: '2px 8px', borderRadius: '10px', fontSize: '0.68rem', fontWeight: 800 }}>
                              ★ COVER
                            </span>
                          )}
                          ...
                          >
                            {!isCover && (
                              <button
                                ...
                                style={{ background: 'none', border: 'none', color: '#D4AF37', fontSize: '0.72rem', fontWeight: 700, cursor: 'pointer' }}
                              >
                                Set Cover
                              </button>
                            )}
              ...
              <div style={{ textAlign: 'right' }}>
                <button
                  ...
                  style={{ padding: '10px 24px', background: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '8px', fontWeight: 700, cursor: 'pointer', color: '#475569' }}
                >
            ...
            >
              ...
              <form onSubmit={handleAlbumSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className="form-group" style={{ margin: 0 }}>
                  <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1e293b' }}>Event Album Title *</label>
                  <input
                    type="text"
                    required
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                  <div className="form-group" style={{ margin: 0 }}>
                    <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1e293b' }}>Category *</label>
                    <select
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1e293b' }}>Location / City</label>
                    <input
                      type="text"
                ...
                <div className="form-group" style={{ margin: 0 }}>
                  <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1e293b' }}>Album Description</label>
                  <textarea
                    rows="2"
