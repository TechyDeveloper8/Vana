      ...
      <div className="container" style={{ maxWidth: '960px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '2.8rem', color: '#1F1F1F', marginBottom: '16px' }}>
            Terms & <span style={{ background: 'linear-gradient(135deg, #D4AF37 0%, #B8860B 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Conditions</span>
          </h1>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '12px' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(212, 175, 55, 0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#D4AF37', fontSize: '1.3rem', flexShrink: 0 }}>
              <i className="fa-solid fa-triangle-exclamation"></i>
            </div>
            <div>
              <h3 style={{ color: '#D4AF37', fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.3rem', margin: 0 }}>
                STRICT NON-REFUNDABLE TICKET POLICY
              </h3>
              <div style={{ fontSize: '0.75rem', letterSpacing: '1.5px', textTransform: 'uppercase', color: '#E7DDD1' }}>
                All Bookings & Pass Sales Are Final
              </div>
            </div>
          </div>
          <p style={{ fontSize: '0.95rem', color: '#E7DDD1', margin: 0, lineHeight: 1.6 }}>
        ...
        <div style={{ background: '#FFFFFF', border: '1px solid #E7DDD1', borderRadius: '20px', padding: '40px 36px', boxShadow: '0 10px 30px rgba(31, 31, 31, 0.04)', lineHeight: 1.8, color: '#4B5563' }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", color: '#1F1F1F', fontSize: '1.4rem', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="fa-solid fa-ban" style={{ color: '#B8860B', fontSize: '1.2rem' }}></i>
            ...
            <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
              <li style={{ marginBottom: '8px' }}>
                <strong>No Cash Refunds:</strong> Ticket passes cannot be cancelled, refunded, or exchanged for cash after payment confirmation.
              </li>
              <li style={{ marginBottom: '8px' }}>
                <strong>Personal Absence / Travel Delays:</strong> Failure to attend the event, arriving late, personal emergencies, traffic conditions, or change of personal schedule will not entitle the pass holder to a refund or replacement.
              </li>
              <li style={{ marginBottom: '8px' }}>
                <strong>Non-Transferable QR Pass:</strong> Each digital QR pass code is linked to the primary purchaser's account and booking ID. Reselling tickets above face value or unauthorized duplication is strictly prohibited.
              </li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", color: '#1F1F1F', fontSize: '1.4rem', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="fa-solid fa-qrcode" style={{ color: '#B8860B', fontSize: '1.2rem' }}></i>
              2. Venue Gate Entry & Scanner Validation
            </h3>
            <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
              <li style={{ marginBottom: '8px' }}>
                <strong>Digital Ticket Pass Requirement:</strong> Attendees must present the official digital ticket pass email (sent via Gmail SMTP) or show the pass on their Vana user dashboard on a mobile device.
              </li>
              <li style={{ marginBottom: '8px' }}>
                <strong>Single-Validation Scanner Check:</strong> Gate entry scanners operated by Vana staff will scan the QR code. Each pass permits entry equal to the booked quantity. Once validated, duplicate attempts will be denied.
              </li>
              <li style={{ marginBottom: '8px' }}>
                <strong>Government Photo ID:</strong> Gate security staff may request a matching government-issued photo ID (Aadhaar, Passport, Driving License, Voter ID) to verify identity.
              </li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", color: '#1F1F1F', fontSize: '1.4rem', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="fa-solid fa-calendar-xmark" style={{ color: '#B8860B', fontSize: '1.2rem' }}></i>
          ...
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", color: '#1F1F1F', fontSize: '1.4rem', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="fa-solid fa-shield-halved" style={{ color: '#B8860B', fontSize: '1.2rem' }}></i>
          ...
          <div>
            <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", color: '#1F1F1F', fontSize: '1.4rem', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="fa-solid fa-headset" style={{ color: '#B8860B', fontSize: '1.2rem' }}></i>
            ...
            <div style={{ background: '#F6EFE5', border: '1px solid #E7DDD1', borderRadius: '12px', padding: '16px 20px', fontSize: '0.92rem', color: '#1F1F1F' }}>
              <div><strong>Vana Entertainments Event Ticketing Desk</strong></div>
